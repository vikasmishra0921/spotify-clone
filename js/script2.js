...
async function getsongs(folder) {
  ...
  let a = await fetch(`https://spotify-clone-omega-self.vercel.app//${folder}/`)
...
async function displayAlbums() {
  ...
  let a = await fetch(`https://spotify-clone-omega-self.vercel.app//songs/`)
  ...
  for (let index = 0; index < array.length; index++) {
    ...
    if (e.href.includes("/songs/") && !e.href.includes(".htaccess")){
      ...
      let a = await fetch(`https://spotify-clone-omega-self.vercel.app//songs/${folder}/info.json`)
